...
for i in range(len(holdperlist)):
    ...
    tempsum = sumportmonth(tempport, ['signalname', 'samptype', 'port'], Nstocksmin=20)
...
tempsum = sumportmonth(tempport, group_by_columns=['signalname', 'samptype', 'port'], Nstocksmin=20)
...
sumDeciles = sumportmonth(portDeciles, ['signalname', 'samptype', 'port'], Nstocksmin=20)
...
sumall = sumportmonth(all_data, ['samptype', 'signalname', 'q_cut', 'sweight', 'port'])
